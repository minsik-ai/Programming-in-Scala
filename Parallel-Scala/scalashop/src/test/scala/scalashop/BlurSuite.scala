...
class BlurSuite extends FunSuite {
  ...
  test("HorizontalBoxBlur.parBlur with radius 2 & numTasks 2 should correctly blur the entire " +
    "4x3 image") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur with radius 2 & numTasks 2 should correctly blur the entire " +
    "4x3 image") {
    val w = 4
    val h = 3
    val src = new Img(w, h)

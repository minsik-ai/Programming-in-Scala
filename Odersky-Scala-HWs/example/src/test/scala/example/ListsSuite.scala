 ...
 */
 @RunWith(classOf[JUnitRunner])
  ...
  test("sum of non minus numbers") {
    assert(sum(List(2,3,7)) === 12)
    assert(sum(List(0)) === 0)
    assert(sum(List(12)) === 12)
    assert(sum(List(0, 0, 0, 0, 0)) === 0)
    assert(sum(List(0, 0, 0, 0, 0, 1)) === 1)
  }
  ...
  test("sum of negative numbers") {
    assert(sum(List(-2, -4, -1)) === -7)
    assert(sum(List(-23)) === -23)
    assert(sum(List(-23, -1, 12, 34)) === 22)
  }
  ...
  test("max of non minus numbers") {
    assert(max(List(3, 7, 2)) === 7)
    assert(max(List(1, 2, 6, 3, 2)) === 6)
    assert(max(List(1)) === 1)
    assert(max(List(1, 1, 1, 1)) === 1)
    assert(max(List(1, 2, 3, 1, 2, 3, 1, 2, 3)) === 3)
    assert(max(List(0)) === 0)
  ...
  test("max of negative numbers") {
    ...
    assert(max(List(1, 2, -6, 3, 2)) === 3)
    assert(max(List(-23)) === -23)
    assert(max(List(-3, -3, -3, -5)) === -3)
  }
}
